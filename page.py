...
from .table import TableFinder, TableFinder2
...
class Page(Container):
    ...
    ### for development
    def debug_tablefinder2(self, table_settings={"snap_tolerance":1e-2, "join_tolerance":3}):
        return TableFinder2(self, table_settings)

    def find_tables2(self, table_settings={"snap_tolerance":1e-2, "join_tolerance":3}):
        return TableFinder2(self, table_settings).tables

    def extract_tables2(self, table_settings={"snap_tolerance":1e-2, "join_tolerance":3}):
    ...
    def extract_table2(self, table_settings={"snap_tolerance":1e-2, "join_tolerance":3}):
        table_settings = TableFinder2.resolve_table_settings(table_settings)
        tables = self.find_tables2(table_settings)
